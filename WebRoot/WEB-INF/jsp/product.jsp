...
<div class="container header">
	<div class="span5">
		<div class="logo">
			<a>
				<img src="${pageContext.request.contextPath}/image/eddie/eddie.jpg" alt="Eddie商城">
			</a>
		</div>
	</div>
	<div class="span9">
<div class="headerAd">
					<img src="image\eddie/header.jpg" alt="正品保障" title="正品保障" height="50" width="320">
</div>	</div>
		...
		<div class="span18 last">
			...
			<form id="cartForm" action="${ pageContext.request.contextPath }/cart_addCart.action" method="post" >
				...
				<div class="action">
					...
					<div class="buy">
							<input id="addCart" class="addCart" value="加入购物车" type="button" onclick="appendCart()"/>
					</div>
				</div>
			</form>
...
<div class="container footer">
	...
	<div class="span24">
		<div class="copyright">Copyright © 2015-2018 网上商城 版权所有</div>
	</div>
</div>
</body>
</html>