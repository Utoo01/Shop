			...
			<table cellSpacing="1" cellPadding="5" width="100%" align="center" bgColor="#eeeeee" style="border: 1px solid #8ba7e3" border="0">
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff">
						...
						<select name="is_hot">
							<option value="1" &lt s:if test="model.is_hot==1"&gt selected &lt/s:if &gt>是</option>
							<option value="0" &lt s:if test="model.is_hot==0"&gt selected &lt/s:if&gt>否</option>
						</select>
					</td>
				</tr>
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff" colspan="3">
						<select name="categorySecond.csid">
							<s:iterator var="cs" value="csList">
								<option value="&lt s:property value="#cs.csid"/&gt" &lt s:if test="#cs.csid == model.categorySecond.csid">selected &lt/s:if&gt&gt&lt s:property value="#cs.csname"/&gt</option>
							</s:iterator>
						</select>
					</td>
				</tr>
